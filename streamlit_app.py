...
def analyse(doc_text):
    """The three stages, in order. Each hands structured data to the next."""
...
with right:
    if go:
        ...
        st.info("Load a tender on the left and press **Analyse**. The sample is a composite of the vague phrasing that shows up in real public-sector tenders.")from openai import OpenAI
from pypdf import PdfReader
